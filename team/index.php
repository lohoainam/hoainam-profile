    ...
    <div id="shoutform">
        ...
        <div id="upstyle">
            ...
            <select id="upcolor">
                ...
                <option style="background: Gold;" value="Gold">HoaiNam Dev</option>
                <option style="background: Khaki;" value="Khaki">HoaiNam Dev</option>
                <option style="background: Orange;" value="Orange">HoaiNam Dev</option>
                <option style="background: LightPink;" value="LightPink">HoaiNam Dev</option>
                <option style="background: Salmon;" value="Salmon">HoaiNam Dev</option>
                <option style="background: Tomato;" value="Tomato">HoaiNam Dev</option>
                <option style="background: Red;" value="Red">HoaiNam Dev</option>
                <option style="background: Brown;" value="Brown">HoaiNam Dev</option>
                <option style="background: Maroon;" value="Maroon">HoaiNam Dev</option>
                <option style="background: DarkGreen;" value="DarkGreen">HoaiNam Dev</option>
                <option style="background: DarkCyan;" value="DarkCyan">HoaiNam Dev</option>
                <option style="background: LightSeaGreen;" value="LightSeaGreen">HoaiNam Dev</option>
                <option style="background: LawnGreen;" value="LawnGreen">HoaiNam Dev</option>
                <option style="background: MediumSeaGreen;" value="MediumSeaGreen">HoaiNam Dev</option>
                <option style="background: BlueViolet;" value="BlueViolet">HoaiNam Dev</option>
                <option style="background: Cyan;" value="Cyan">HoaiNam Dev</option>
                <option style="background: Blue;" value="Blue">HoaiNam Dev</option>
                <option style="background: DodgerBlue;" value="DodgerBlue">HoaiNam Dev</option>
                <option style="background: LightSkyBlue;" value="LightSkyBlue">HoaiNam Dev</option>
                <option style="background: White;" value="White">HoaiNam Dev</option>
                <option style="background: DimGray;" value="DimGray">HoaiNam Dev</option>
                <option style="background: DarkGray;" value="DarkGray">HoaiNam Dev</option>
                <option style="background: Black;" value="Black">HoaiNam Dev</option>
            </select>
