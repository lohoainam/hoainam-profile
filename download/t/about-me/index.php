...
<html lang="en" class="theme-dark">
  <head>
    ...
    <meta name="author" content="HoaiNamDev">
    <meta name="description" content="Chính Sách Và Giới Thiệu Về Trang Website Này !">
    <meta name="keywords" content="Chính sách trang web, about me Hoài Nam">
    <title>Chính sách trang web, about me thanh diệu</title>
    <link rel="shortcut icon" href="https://imgur.io/4lSyggf?r">
    <link rel="stylesheet" href="./data-virus/style.min.css">
    <script src="./data-virus/Apache-2.0.js"></script>
    <script src="./data-virus/main.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@9"></script>
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Permanent Marker|Carter One|Rowdies">
  ...
  <body>
    <header class="header-container layout-block layout-padding">
      <div class="header-inner content-padding-large soft-size--large soft-style--box">
        ...
        <nav class="header-nav">
          ...
          <div class="header-nav--list">
            <div>
              <a class="list-item soft-size--small soft-style--hover soft-style--active" href="https://mxhfblhn.cf" title="HOME">🏠 HOME</a>
              <a class="list-item soft-size--small soft-style--hover soft-style--active" href="#" title="POSTS">🗂️ POSTS</a>
              <a class="list-item soft-size--small soft-style--hover soft-style--active" href="https://mxhfblhn.cf/download/t/about-me" title="ABOUT">😈 ABOUT</a>
              <a class="list-item soft-size--small soft-style--hover soft-style--active" href="https://youtu.be/e_SMDjKXbEY" title="LINK">🔗 LINK</a>
            </div>
          </div>
        </nav>
      </div>
        ...
        <div class="article-info">
          <div class="article-header layout-padding">
            <div class="article-cover card-container content-padding-large soft-size--large soft-style--box ">
              ...
              <div class="card-text">
                <h1 class="card-text--title">About</h1>
                <p class="card-text--row">" MXHFBLHN.CF, website chuyên chia sẽ thủ thuật công nghệ "</p>
              </div>
            </div>
          </div>
          <div class="article-content">
            <div class="markdown-body content-padding-large soft-size--large soft-style--box">
              <div class="aplayer-box" data-name='energy-amp-love' data-artist='DVT' data-url='http://mxhfblhn.cf/hoainamft-data/files/music-home.mp3' data-cover='https://i.imgur.com/pBDJXkZ.jpg'></div>
              <p><a href="https://mxhfblhn.cf" target="_blank" rel="noopener">Mxhfblhn Chấm Cf </a> là gì,
            đây là 1 trang web blog được viết bằng ngôn ngữ thuần html, javascript, php, css... </p>
              <p>Dưới đây là ngôn ngữ của trang web này:</p>
              <ul>
                <li>
                  <a href="https://www.php.net/">https://www.php.net/</a>
                </li>
                <li>
                  <a href="https://html.com/">https://html.com/</a>
                </li>
                <li>
                  <a href="https://www.css3.com/">https://www.css3.com/</a>
                </li>
                <li>
                  <a href="https://www.javascript.com/">https://www.javascript.com/</a>
                </li>
                <li>
                  <a href="https://www.mysql.com/">https://www.mysql.com/</a>
                </li>
              </ul>
              <p>MxhFbLhn.Cf phát triển vì mục đích chia sẽ những mã nguồn, thủ thuật, mod game, công nghệ, và không có gắn quảng cáo ads.</p>
              <p>Đôi khi tôi có gắn links rút gọn ở những bài share ( posted ) đó là điều bình thường không có gì phải lo lắng.</p>
              <p>Website được phát triển bởi công ti 1 thành viên và không có đối tác hợp tác.</p>
              <p>Liên hệ tôi qua zalo <a href="https://zalo.me/lohoainam" target="_blank" rel="noopener">Zalo VN</a>. </p>
            </div>
          </div>
        </div>
          ...
          <section class="aside-widget widget-author content-padding-large soft-size--large soft-style--box">
            <div class="widget-body">
              <div class="author-box avatar">
                <img class="author-avatar soft-size--round soft-style--box" src="https://i.imgur.com/4lSyggf.jpg" alt="HoaiNamCoder">
                <h2 class="author-name text-ellipsis">HoaiNamDev</h2>
                <p class="author-desc text-ellipsis">Look at me ?</p>
              </div>
            </div>
          </section>
          <section class="aside-widget widget-categories content-padding-large soft-size--large soft-style--box">
            ...
            <div class="widget-body">
              <ul class="categories-list">
                <li>
                  <a href="#HoaiNamCoder">HoaiNamCoder</a>
                  <span>6</span>
                </li>
                <li>
                  <a href="#HoaiNamCoder">HoaiNamCoder</a>
    ...
    <footer class="footer-container layout-block">
      <div class="social-icons">
        <a href="https://github.com/lohoainam2008//" class="soft-size--primary soft-style--box" target="_blank" rel="noopener noreferrer">
          ...
          <a href="https://mxhfblhn.cf/404" class="soft-size--primary soft-style--box" target="_blank" rel="noopener noreferrer">
        ...
        <a class="soft-size--primary soft-style--box" href="https://mxhfblhn.cf/404/" target="_blank" rel="noopener noreferrer">
      ...
      <p>Admin: <a href="https://mxhfblhn.cf/" target="_blank">HoaiNamDev</a>
      </p>
      <p>All rights reserved - © 2023<a href="https://mxhfblhn.cf/" target="_blank" rel="noopener noreferrer"> - HoaiNamCoder</a>
      </p>
      </p>
      <p>
